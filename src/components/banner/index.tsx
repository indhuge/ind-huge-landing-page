    ...
    return (
        <div style={{ backgroundImage: "linear-gradient(90deg, #01666C 0%, #014E6C 31.25%, #01506B 53.65%, #01916B 100%)" }} className="vw-[100vw]">
            ...
            >
                ...
                <div className={`flex items-center flex-shrink justify-center col-span-5 bg-[length:100%_100%] bg-no-repeat mt-20 h-[280px] aspect-video TabletPortrait:w-[90vw] TabletPortrait:h-fit TabletPortrait:mb-[5vh]`} style={{ backgroundImage: `url(${borda.src})` }}>
